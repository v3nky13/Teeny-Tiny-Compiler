...
class Lexer:
    ...
    def getToken(self):
        ...
        if self.curChar == '+':
            ...
            while self.curChar != '\"':
                # Don't allow special characters in the string. No espace characters, newlines, tabs or %.
...
class Token:
    def __init__(self, tokenText, tokenKind):
        self.text = tokenText       # The token's acutal text. Used for identifiers, strings and numbers.
